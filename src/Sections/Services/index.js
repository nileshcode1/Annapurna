  ...
  return (
    <ServiceSection id="services">
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Design"
          title={<h1>Cost-effective LED display</h1>}
          subText={<h5>Ready-to-use panel with superior quality</h5>}
        />
        <OBJ>
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Develop"
          title={<h1>Empowering Your Brand Through Digital Signage</h1>}
          subText={
            <h5>
              Enhance your brand's presence with our innovative digital signage
              solutions.
            </h5>
          }
        />
      ...
      <Content>
        <TextBlock
          ...
          subText={<h5>Your Vision, Our Innovation</h5>}
        />
        <OBJ>
